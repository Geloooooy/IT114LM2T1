...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator runat="server" ControlToValidate="fullName" ErrorMessage="Full Name is required" Display="Dynamic" /><br />
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100"
        ErrorMessage="Age must be between 0 and 100" Display="Dynamic" /><br />
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$"
        ErrorMessage="Invalid email format" Display="Dynamic" /><br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email"
        ErrorMessage="Email and Confirm Email must match" Display="Dynamic" /><br />
